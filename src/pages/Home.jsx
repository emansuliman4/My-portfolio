  ...
  return (
    <div className="p-4">
      <div className="w-80 h-75 mx-auto bg-black rounded-[50%] relative font-mono">
        ...
        <p className="font-bold text-white bg-black rounded-[20%] h-20 w-72 sm:w-80 animate-waveText text-4xl sm:text-5xl flex justify-center items-center whitespace-nowrap absolute -bottom-50 ">
          DEVELOPER
        </p>
      </div>
    </div>
